// scripts/change-state-to-ended.ts
...
async function main() {
  ...
  // Call changeStateToEnded
  console.log("Initiating state change to Ended...");
  const tx = await campaign.changeStateToEnded();
  ...
  console.log("State changed to Ended successfully!\n");
}
